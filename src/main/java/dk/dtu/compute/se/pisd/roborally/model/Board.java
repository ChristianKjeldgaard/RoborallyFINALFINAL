...
public class Board extends Subject {
    ...
    public int getCheckpointsNumber(){
        ...
        for(Space[] space: spaces){
            for(Space singleSpace: space){
                if(singleSpace.getActions() != null){
                    if(singleSpace.getActions().get(0) instanceof Checkpoint){
                        numberOfCheckpointsOnBoard += 1;
                    }
                }
            }
        }
        return numberOfCheckpointsOnBoard;
    }
