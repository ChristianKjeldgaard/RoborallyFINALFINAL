                    ...
                    if(player.getProgramField(player.board.getStep()).getCard() != null){
                        ...
                        if(command.isInteractive()) {
                            for (Command command1 : command.getOptions()) {
                                Button optionButton = new Button(command1.name());
                                optionButton.setOnAction(e -> gameController.executeCommandOptionAndContinue(command1));
